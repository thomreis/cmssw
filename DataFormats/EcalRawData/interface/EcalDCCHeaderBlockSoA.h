...
using EcalTCCStatusArray = edm::StdArray<int16_t, MAX_TCC_SIZE>;
using EcalTriggerTowerFlagArray = edm::StdArray<int16_t, MAX_TT_SIZE>;
using EcalFEStatusArray = edm::StdArray<int16_t, MAX_TT_SIZE>;
using EcalFEBxArray = edm::StdArray<int16_t, MAX_TT_SIZE>;
using EcalTCCBxArray = edm::StdArray<int16_t, MAX_TCC_SIZE>;
using EcalFELv1Array = edm::StdArray<int16_t, MAX_TT_SIZE>;
using EcalTCCLv1Array = edm::StdArray<int16_t, MAX_TCC_SIZE>;
