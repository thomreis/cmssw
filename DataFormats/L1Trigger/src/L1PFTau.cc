...
// default constructor
l1t::L1PFTau::L1PFTau() : m_data(0), m_tauType(12), m_EoH(0), m_HoE(0), m_z0(0), m_time(0), m_tauIsoQual(0), m_tauRelIsoQual(0), m_relativeIsolation(100), m_rawIsolation(0), m_chargedIsolation(0), m_passTightIso(0), m_passMediumIso(0),m_passLooseIso(0), m_passVLooseIso(0), m_passTightRelIso(0), m_passMediumRelIso(0),m_passLooseRelIso(0), m_passVLooseRelIso(0){  };
