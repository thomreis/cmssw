...
L1TMuonGlobalParamsESProducer::L1TMuonGlobalParamsESProducer(const edm::ParameterSet& iConfig)
{
   ...
   m_params.setBOPosMatchQualLUTMaxDR(iConfig.getParameter<double>("BOPosMatchQualLUTMaxDR"), iConfig.getParameter<double>("BOPosMatchQualLUTMaxDREtaFine"), iConfig.getParameter<double>("BOPosMatchQualLUTfEta"), iConfig.getParameter<double>("BOPosMatchQualLUTfPhi"));
   m_params.setBONegMatchQualLUTMaxDR(iConfig.getParameter<double>("BONegMatchQualLUTMaxDR"), iConfig.getParameter<double>("BONegMatchQualLUTMaxDREtaFine"), iConfig.getParameter<double>("BONegMatchQualLUTfEta"), iConfig.getParameter<double>("BONegMatchQualLUTfPhi"));
   m_params.setFOPosMatchQualLUTMaxDR(iConfig.getParameter<double>("FOPosMatchQualLUTMaxDR"), iConfig.getParameter<double>("FOPosMatchQualLUTfEta"), iConfig.getParameter<double>("FOPosMatchQualLUTfPhi"));
   m_params.setFONegMatchQualLUTMaxDR(iConfig.getParameter<double>("FONegMatchQualLUTMaxDR"), iConfig.getParameter<double>("FONegMatchQualLUTfEta"), iConfig.getParameter<double>("FONegMatchQualLUTfPhi"));
