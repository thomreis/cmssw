...
L1TMuonGlobalParamsESProducer::L1TMuonGlobalParamsESProducer(const edm::ParameterSet& iConfig)
{
   ...
   m_params.setFwdPosSingleMatchQualLUTMaxDR(iConfig.getParameter<double>("FwdPosSingleMatchQualLUTMaxDR"), iConfig.getParameter<double>("FwdPosSingleMatchQualLUTfEta"), iConfig.getParameter<double>("FwdPosSingleMatchQualLUTfPhi"));
   m_params.setFwdNegSingleMatchQualLUTMaxDR(iConfig.getParameter<double>("FwdNegSingleMatchQualLUTMaxDR"), iConfig.getParameter<double>("FwdNegSingleMatchQualLUTfEta"), iConfig.getParameter<double>("FwdNegSingleMatchQualLUTfPhi"));
   m_params.setOvlPosSingleMatchQualLUTMaxDR(iConfig.getParameter<double>("OvlPosSingleMatchQualLUTMaxDR"), iConfig.getParameter<double>("OvlPosSingleMatchQualLUTfEta"), iConfig.getParameter<double>("OvlPosSingleMatchQualLUTfPhi"));
   m_params.setOvlNegSingleMatchQualLUTMaxDR(iConfig.getParameter<double>("OvlNegSingleMatchQualLUTMaxDR"), iConfig.getParameter<double>("OvlNegSingleMatchQualLUTfEta"), iConfig.getParameter<double>("OvlNegSingleMatchQualLUTfPhi"));
   m_params.setBOPosMatchQualLUTMaxDR(iConfig.getParameter<double>("BOPosMatchQualLUTMaxDR"), iConfig.getParameter<double>("BOPosMatchQualLUTMaxDREtaFine"), iConfig.getParameter<double>("BOPosSingleMatchQualLUTfEta"), iConfig.getParameter<double>("BOPosSingleMatchQualLUTfPhi"));
   m_params.setBONegMatchQualLUTMaxDR(iConfig.getParameter<double>("BONegMatchQualLUTMaxDR"), iConfig.getParameter<double>("BONegMatchQualLUTMaxDREtaFine"), iConfig.getParameter<double>("BONegSingleMatchQualLUTfEta"), iConfig.getParameter<double>("BONegSingleMatchQualLUTfPhi"));
   m_params.setFOPosMatchQualLUTMaxDR(iConfig.getParameter<double>("FOPosMatchQualLUTMaxDR"), iConfig.getParameter<double>("FOPosSingleMatchQualLUTfEta"), iConfig.getParameter<double>("FOPosSingleMatchQualLUTfPhi"));
   m_params.setFONegMatchQualLUTMaxDR(iConfig.getParameter<double>("FONegMatchQualLUTMaxDR"), iConfig.getParameter<double>("FONegSingleMatchQualLUTfEta"), iConfig.getParameter<double>("FONegSingleMatchQualLUTfPhi"));
   ...
   auto bOPosMatchQualLUT = l1t::MicroGMTMatchQualLUTFactory::create (iConfig.getParameter<std::string>("BOPosMatchQualLUTPath"), iConfig.getParameter<double>("BOPosMatchQualLUTMaxDR"), iConfig.getParameter<double>("BOPosSingleMatchQualLUTfEta"), iConfig.getParameter<double>("BOPosSingleMatchQualLUTfPhi"), l1t::cancel_t::omtf_bmtf_pos, fwVersion);
   auto bONegMatchQualLUT = l1t::MicroGMTMatchQualLUTFactory::create (iConfig.getParameter<std::string>("BONegMatchQualLUTPath"), iConfig.getParameter<double>("BONegMatchQualLUTMaxDR"), iConfig.getParameter<double>("BONegSingleMatchQualLUTfEta"), iConfig.getParameter<double>("BONegSingleMatchQualLUTfPhi"), l1t::cancel_t::omtf_bmtf_neg, fwVersion);
   auto fOPosMatchQualLUT = l1t::MicroGMTMatchQualLUTFactory::create (iConfig.getParameter<std::string>("FOPosMatchQualLUTPath"), iConfig.getParameter<double>("FOPosMatchQualLUTMaxDR"), iConfig.getParameter<double>("FOPosSingleMatchQualLUTfEta"), iConfig.getParameter<double>("FOPosSingleMatchQualLUTfPhi"), l1t::cancel_t::omtf_emtf_pos, fwVersion);
   auto fONegMatchQualLUT = l1t::MicroGMTMatchQualLUTFactory::create (iConfig.getParameter<std::string>("FONegMatchQualLUTPath"), iConfig.getParameter<double>("FONegMatchQualLUTMaxDR"), iConfig.getParameter<double>("FONegSingleMatchQualLUTfEta"), iConfig.getParameter<double>("FONegSingleMatchQualLUTfPhi"), l1t::cancel_t::omtf_emtf_neg, fwVersion);
