...
L1TkTauFromCalo = cms.EDProducer("L1TkTauFromCaloProducer",
      ...
      L1TTTracks_AbsEtaMax               = cms.double(  2.3  ),  # Max |eta| applied on all L1TkTracks [unitless]
      L1TTTracks_POCAzMax                = cms.double(  30.0 ),  # Max POCA-z for L1TkTracks [cm] 
      L1TTTracks_NStubsMin               = cms.uint32(  4    ),  # Min number of stubs per L1TkTrack [unitless]
      L1TTTracks_RedChiSquareBarrelMax   = cms.double(  10.0 ),  # Max chi squared for L1TkTracks in Barrel [unitless] 
      L1TTTracks_RedChiSquareEndcapMax   = cms.double(  8.0  ),  # Max chi squared for L1TkTracks in Endcap [unitless]
      L1TTTracks_DeltaPOCAzFromPV        = cms.double(10000  ),  # Max POCA-z distance from the z-vertex of the L1TkPV [cm]. (1000.0 to disable)
