...
TkPhotons = cms.EDProducer("TkEmProducer",
        ...
        L1EGammaInputTag = cms.InputTag("simCaloStage2Digis",""),
                                                ...
                                                #     ("SLHCL1Extras","EGamma") or ("SLHCL1Extras","IsoEGamma")
                                                #   - for the new clustering algorithm of Jean-Baptiste et al,
                                                #     use ("SLHCL1ExtrasNewClustering","IsoEGamma") or
                                                #     ("SLHCL1ExtrasNewClustering","EGamma").
        ...
        PrimaryVtxConstrain = cms.bool( False ),  # default = False
						  # if set to True, the default isolation is the PV constrained one, where TkPrimaryVertex is used to constrain
        ...
        L1VertexInputTag = cms.InputTag("TkPrimaryVertex"),     # in cm. Used to compute the isolation with PrimaryVtxConstrain 
)
