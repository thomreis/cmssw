#ifndef DQM_L1TMonitor_L1TStage2MuonCompDqm_h
#define DQM_L1TMonitor_L1TStage2MuonCompDqm_h
...
class L1TStage2MuonCompDqm : public DQMGlobalEDAnalyzer<muoncompdqm::Histograms> {

 public:

  L1TStage2MuonCompDqm(const edm::ParameterSet& ps);
  ~L1TStage2MuonCompDqm() override = default;
 ...
 private:  
  ...
  edm::EDGetTokenT<BXVector<edm::Ref<l1t::MuonBxCollection>>> coll1ExcessToken_;
  edm::EDGetTokenT<BXVector<edm::Ref<l1t::MuonBxCollection>>> coll2ExcessToken_;
  edm::EDGetTokenT<BXVector<std::pair<edm::Ref<l1t::MuonBxCollection>, edm::Ref<l1t::MuonBxCollection>>>> matchToken_;
  edm::EDGetTokenT<BXVector<std::pair<edm::Ref<l1t::MuonBxCollection>, edm::Ref<l1t::MuonBxCollection>>>> mismatchToken_;
  std::string monitorDir_;
  std::string muonColl1Title_;
  std::string muonColl2Title_;
