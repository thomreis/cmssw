...
#    EELaserLedUncalibRecHit = cms.untracked.InputTag("ecalLaserLedUncalibRecHit", "EcalUncalibRecHitsEE"),
    ...
    EBCpuSrFlag = cms.untracked.InputTag("ecalDigis@cpu"),
    EECpuSrFlag = cms.untracked.InputTag("ecalDigis@cpu"),
    EBGpuSrFlag = cms.untracked.InputTag("ecalDigis@cuda"),
    EEGpuSrFlag = cms.untracked.InputTag("ecalDigis@cuda"),
