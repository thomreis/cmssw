...
COND_SERIALIZATION_INSTANTIATE(EcalCondObjectContainer<EcalPh2PulseShape>);
COND_SERIALIZATION_INSTANTIATE(EcalCondObjectContainer<EcalPulseCovariance>);
COND_SERIALIZATION_INSTANTIATE(EcalCondObjectContainer<EcalPh2PulseCovariance>);
COND_SERIALIZATION_INSTANTIATE(EcalCondObjectContainer<EcalPulseSymmCovariance>);
COND_SERIALIZATION_INSTANTIATE(EcalCondObjectContainer<EcalPh2PulseSymmCovariance>);
...
COND_SERIALIZATION_INSTANTIATE(EcalPh2PulseShape);
COND_SERIALIZATION_INSTANTIATE(EcalPh2PulseCovariance);
COND_SERIALIZATION_INSTANTIATE(EcalPh2WeightSet);
COND_SERIALIZATION_INSTANTIATE(EcalPh2TBWeights);
